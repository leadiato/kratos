...
const headers = {
  'Accept': 'application/json',  'Cookie': 'string',  'Authorization': 'API_KEY'
}
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|config|[registrationFlowMethodConfig](#schemaregistrationflowmethodconfig)|true|none|none|
|method|[CredentialsType](#schemacredentialstype)|true|none|and so on.|
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|config|[FlowMethodConfig](#schemaflowmethodconfig)|true|none|none|
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|config|[verificationFlowMethodConfig](#schemaverificationflowmethodconfig)|true|none|none|
|method|string|true|none|Method contains the request credentials type.|
